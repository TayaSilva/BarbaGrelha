	...
	return (
		<div className="relative h-screen w-full overflow-hidden">
			...
			<div className="relative z-10 h-full flex justify-center items-center px-4">
				...
				<div className="absolute top-[184px] left-1/2 transform -translate-x-1/2 z-20">
					<Image src={LogoBG} alt="Logo" width={120} height={120} />
				</div>

				{/* Card */}
				<div className="w-full max-w-sm bg-principal-50 bg-opacity-95 dark:bg-principal-200 dark:bg-opacity-95 p-8 rounded-md shadow-md backdrop-blur-md pt-16">
